...
const ProjectSmallFeed = ({ project } : ProjectType) => {
  ...
  return (
    <article className={`w-full mx-1 my-8 px-4 relative hover:cursor-pointer hover:bg-gray-200 duration-200
      ...
      <div className='w-full flex flex-col items-start justify-between pl-4 mt-6'>
