...
export default function Home() {
  ...
  return (
    <> 
      ...
      <main className='flex items-center justify-between w-full fixed bg-light'>
        <div className='w-1/2 bg-slate-200 relative mx-32 mt-16 rounded-2xl pt-4 mb-12 bg-gradient-to-b from-slate-200 to-light shadow-2xl overflow-hidden'>
